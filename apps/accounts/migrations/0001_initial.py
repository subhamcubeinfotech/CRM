    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_type', models.CharField(choices=[('customer', 'Customer'), ('carrier', 'Carrier'), ('vendor', 'Vendor')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('customer', 'Customer'), ('driver', 'Driver'), ('warehouse', 'Warehouse Staff'), ('sales', 'Sales')], default='customer', max_length=20)),
                ('phone', models.CharField(blank=True, max_length=20)),
